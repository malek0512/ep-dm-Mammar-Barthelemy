...
=======
Nous avons essentiellement modifié la fonction run_task() qui désormais depile une tâche selon l'une des 4 politiques srpt_pmtn, spt_pmtn, spt, et fifo passéé en paramètre.
>>>>>>> 4e2f847275405692b514ddb834147322b1f0ec09
...
Pour une loi exponentielle fixons nous une valeur X = 1
...
ggplot(data=df[df$lambda==0.8,], aes(x = id)) + 
...
Rappelons que cces stratégies sont évaluées sur la base d'un même flux de requêtes entrant.
Sur cette figure nous pouvons remarquer la précense de valeurs extrêmes sur pratiquement chacun des modes.

La politique Fifo traite les requetes dans l'ordre d'arrivé. On constate que ces extremums sont modérés
